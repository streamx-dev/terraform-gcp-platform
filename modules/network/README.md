...
| <a name="input_gcp_project_region"></a> [gcp\_project\_region](#input\_gcp\_project\_region) | This string variable indicates the GCP region where your network resources will be located. The default value we have set is 'europe-central2'. | `string` | `"europe-central2"` | no |
